                    ...
                    <html lang="en">
                        ...
                        <body>
                            <section class="ticket">
                                <div class="content" style="margin: 40px; padding: 1px;">
                                    ...
                                    <form method="GET" action="{{ route('tickets.index') }}" class="form-inline mb-3">
                                        ...
                                        <div class="Buscar">
                                            <form class="d-flex justify-content-center" onsubmit="return false;">
                                                <input id="searchInput" class="form-control form-control-sm me-2 w-50 Buscar-input" type="search" placeholder="Ingresa ID, Nombre, Prioridad, Estado o Fecha" aria-label="Search" oninput="filterAccordion()">
                                    ...
                                    <!-- Botones -->
                                    <div class="group">
                                        <button class="Btn" onclick="window.location.href='{{ route('tickets.create') }}'">
                                            <div class="sign">+</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="button-group">
                                                            ...
                                                            <button class="edit-button" onclick="window.location.href='{{route('tickets.edit',['ticket'=>$ticket->id])}}'">
                                                            ...
                                                            <button class="Ver-button" onclick="window.location.href='{{ route('tickets.view', $ticket->id) }}'">
